...
function InvAbout() {
  return (
    <>
      <div className="ireightlayer">
        <div className="ireightconts">
          <div className="irecont1">
            <img src={bl_zom} className="irzom"></img>
            <div className="irecont11">
              <div className="irimgbox1">
                <img src={india} className="irindia"></img>
      ...
      <div className="ireightcontents">
        <div className="ireight-nav">
          <div className="irenav1">
            <div className="iren1t">INVESTOR RELATIONS</div>
            <div className="iren1c">Home</div>
            <div className="iren1c">Financials</div>
            <div className="iren1c">Announcements</div>
            <div className="iren1c">Governance</div>
            <div className="iren1c">ESG initiatives</div>
            <div className="iren1c">Resources </div>
            <div className="iren1c">ODR Portal</div>
          </div>
          <div className="irenav2">
            <div className="iren1t">Our Business</div>
            <div className="iren1c">Zomato</div>
            <div className="iren1c">Blinkit</div>
            <div className="iren1c">District</div>
            <div className="iren1c">Hyperpure</div>
          </div>
          <div className="irenav3">
            <div className="iren1t">About Zomato</div>
            <div className="iren1c">Contact Us</div>
            <div className="iren1c">Blog</div>
          </div>
          <div className="irenav4">
            <div className="iren1t">Beyond Business</div>
            <div className="iren1c">ESG initiatives</div>
            <div className="iren1c">ESG Microsite</div>
            <div className="iren1c">Feeding India</div>
          </div>
          <div className="irenav5">
            <div className="iren1t">Learn More</div>
            <div className="iren1c">Privacy</div>
            <div className="iren1c">Terms</div>
            <div className="iren1c">Security</div>
          </div>
          <div className="irenav6">
            <div className="iren1t">social links</div>
            <div className="iren1images">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="#1C1C1C"
                width="25"
      ...
      <div className="irfin">
        <div className="irline"></div>
      </div>
      <div className="irfin2">
        <div className="irfinconts">
