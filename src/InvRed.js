...
function InvRed() {
  ...
  return (
    <>
      <div className="invnav r">
        <div className="innavconts">
          <div className="innavcs1">
            <img src={zomlogo} className="innavlogored"></img>
          ...
          <div className="innav-flex ">
            <div className="innavcs ">
              <p className="innavp2 ">
                <Link to="/Inv" className="red-color">
                  Home
                </Link>
              </p>
              <p className="innavp2">
                <Link to="/financials" className="red-color">
                  Financials
                </Link>
              </p>
              <p className="innavp2">
                <Link to="/Announcement" className="red-color">
                  Announcements
                </Link>
              </p>
              <p className="innavp2">
              ...
              <p className="innavp2">
                <Link to="/governance" className="red-color">
                  Governance
                </Link>
              </p>
            ...
            <p className="innavp21">
              <Link to="/resources" className="red-color">
                Resources
              </Link>
            </p>
          </div>
